...
/**
 * Created by BAO on 2017/12/25.
 */

public class ThemeManager {

    // 默认是日间模式
    private static int mThemeMode = ThemeManager.MODE_DAY;
    // 主题模式监听器
    ...
    public static void setThemeMode(int themeMode) {
        ...
        SharedPreferences.Editor editor = PreferenceManager
                .getDefaultSharedPreferences(App.getContext()).edit();
    ...
    public static int getCurrentThemeRes(Context context, int dayResId) {
        if (getThemeMode() == ThemeManager.MODE_DAY) {
            return dayResId;
        }
        // 资源名
