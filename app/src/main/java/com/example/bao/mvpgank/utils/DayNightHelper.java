...
public class DayNightHelper {
    ...
    private final static String FILE_NAME = "gank_io";
    private final static String THEME_MODE = "day_night_mode";
    ...
    public void setMode(DayNight mode) {
        ...
        editor.putString(THEME_MODE, mode.getName()).apply();
    }
    ...
    public boolean isNight() {
        String mode = mSharedPreferences.getString(THEME_MODE, DayNight.DAY.getName());
